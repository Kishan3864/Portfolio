...
function TimelineItem({
  ...
  return (
    ...
    >
      ...
      >
        <div className="glass rounded-2xl p-6 card-shine group hover:border-[#475569]/30 transition-all duration-300">
          <span
...
export default function JourneySection() {
  ...
  return (
    <section id="journey" className="relative py-32 overflow-hidden">
      <div className="floating-orb w-80 h-80 bg-[#475569] -left-40 top-1/3" />
      <div className="floating-orb w-60 h-60 bg-[#64748B] -right-20 bottom-1/4" />
      ...
      <div className="max-w-6xl mx-auto px-6" ref={ref}>
        ...
        <div className="relative">
          ...
          <div className="md:hidden absolute left-6 top-0 bottom-0 w-0.5 bg-gradient-to-b from-transparent via-[#475569] to-transparent" />
