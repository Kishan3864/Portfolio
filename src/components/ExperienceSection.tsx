...
export default function ExperienceSection() {
  ...
  return (
    <section className="relative py-32 overflow-hidden">
      <div className="floating-orb w-72 h-72 bg-[#FF6B6B] -right-20 top-40" />
      ...
      <div className="max-w-6xl mx-auto px-6" ref={ref}>
        ...
        >
          <span className="text-sm tracking-[0.3em] uppercase text-[#4ECDC4] mb-4 block">
            Where I&apos;ve Worked
          </span>
        ...
        >
          {/* Header */}
          <div className="bg-gradient-to-r from-[#6C63FF]/20 to-[#00D4AA]/20 p-8 md:p-12 border-b border-white/5">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              <div className="flex items-start gap-4">
                <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-[#6C63FF] to-[#00D4AA] flex items-center justify-center shrink-0">
              ...
              <div className="flex items-center gap-6">
                ...
                <span className="px-4 py-2 rounded-full bg-green-500/20 text-green-400 text-sm font-medium flex items-center gap-2">
          ...
          <div className="p-8 md:p-12">
            ...
            <div className="mb-8">
              <div className="flex items-center gap-2 mb-6">
                <Award size={20} className="text-[#6C63FF]" />
        ...
        >
          <div className="glass rounded-2xl p-8 border-l-4 border-[#6C63FF]">
            <h4 className="text-xl font-bold text-white mb-2">FlexYPDF</h4>
            <p className="text-gray-500 text-sm mb-3">Personal Product</p>
          ...
          <div className="glass rounded-2xl p-8 border-l-4 border-[#00D4AA]">
            <h4 className="text-xl font-bold text-white mb-2">MunafaLab</h4>
            <p className="text-gray-500 text-sm mb-3">Personal Product</p>
            <p className="text-gray-400">
